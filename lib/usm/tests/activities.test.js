...
describe('activities', () => {
    ...
    describe('the constructor Activities()', () => {
        ...
        it('throws an error if passed data is not an object', () => {
            expect(() => { new Activities('This is not an object') }).to.throw(ReferenceError)
        })
    ...
    describe('Activities.prototype.render()', () => {
        ...
        context('this.jsonData is valid', () => {
            ...
            it('renders an empty Activities container', async () => {
                return ActivitiesRenderComparator('00_mock-activities-empty')
            })
